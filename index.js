...
const questions = [
    ...
    },
    {
        type: 'input',
        name: 'email',
        message: 'What email are you using for this project?'
    },    
    {
        type: 'input',
        name: 'title',
    ...
    },
    {
        type: 'input',
        name: 'description',
        message: 'Could you write a short description of your project?',
      },
      {
        type: 'list',
        name: 'license',
...
.then((iResopnses) => {writeToFile('README.md', generateMarkdown({ ...iResopnses }));})
};
